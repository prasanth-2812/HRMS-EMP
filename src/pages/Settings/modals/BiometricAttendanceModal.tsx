...
const BiometricAttendanceModal: React.FC<BiometricAttendanceModalProps> = ({ onClose }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Biometric Attendance settings:', settings);
    onClose();
  };
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          ...
          <p>Configure biometric attendance settings</p>
